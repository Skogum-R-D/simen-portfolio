      ...
      <div className="max-w-4xl mx-auto">
        <Card>
          ...
          <CardContent className="space-y-4 text-gray-300">
            ...
            <p>
              His focus is on multi-agent AI systems, distributed architectures, and full-stack engineering. Based in Norway, Simen combines deep technical expertise with a passion for pushing the boundaries of what autonomous systems can achieve.
            </p>
          </CardContent>
        </Card>
      </div>
